...
const sendEmail = async (obj) => {
    try {
        const mailOptions = {
            from: `"Lost & Found Portal" <${envSchema_1.validENV.GMAIL}>`,
            to: obj.to,
            subject: obj.subject,
            html: `
        <div style="font-family: Arial, sans-serif; max-width: 600px; margin: auto; border: 1px solid #e0e0e0; border-radius: 8px; padding: 20px;">
          ...
          <p>If this item belongs to you, please visit the <a href="${envSchema_1.validENV.FRONTEND_URL_DEV}" style="color: #007bff; text-decoration: none;">Lost & Found Portal</a> to claim it.</p>
