  ...
  new passport_google_oauth20_1.Strategy(
    {
      ...
      callbackURL: envSchema_1.validENV.GOOGLE_CALLBACK_URL, // this callback url is the exact url given in the google console it need to hited after successful loging
    },
